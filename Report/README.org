...
This repository is a reusable LaTeX template for academic reports and theses.
It keeps the shared class files and starter structure, but removes project-specific
content so a new document can begin from a clean baseline.
