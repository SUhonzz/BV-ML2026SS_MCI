...
\graphicspath{%
  ...
  {../captures/}%
  {../detections/}%
  {../CustomModel/runs/runs/stifterkennung_yolo11m/}%
  {../CustomModel/TrainingData/Stifterkennung.yolov11/}%
}
...
\Title{%
  Stereo-Rekonstruktion und Stifterkennung
}% 
